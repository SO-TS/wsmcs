...
onMounted(() => {
  ...
  setSEO(null, isEnglish ? 'InternalServerErrorEn' : 'InternalServerErrorZhCN');
});
</script>
  ...
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 px-4">
    <div class="max-w-md w-full text-center">
      ...
      <div class="mx-auto flex items-center justify-center h-24 w-24 rounded-full bg-red-100 dark:bg-red-900/30">
        <span class="text-5xl font-bold text-red-500 dark:text-red-400">500</span>
      </div>
      ...
      <div class="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <button 
          ...
          class="px-6 py-3 border border-gray-300 text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-700 dark:hover:bg-gray-700"
        >
          {{ t('error.refreshPage') }}
        </button>
      </div>
