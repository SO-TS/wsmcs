...
/**
 * @file resize-image.js
 * @description 將指定圖片的分辨率減半
 * @usage node scripts/resize-image.js <input-image> <output-image>
 */
...
if (!inputPath || !outputPath) {
  ...
  console.log('📝 用法: node scripts/resize-image.js <input-image> <output-image>');
  process.exit(1);
}
